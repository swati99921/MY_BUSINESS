...
function Login (){
    ...
    return(
       <div>
        ...
        <h1 className="h3 mb-3 font-weight-normal" style={headerStyles}> Sign in</h1>
        ...
        <a href="#" id="forgot_pswd">Forgot password?</a>
         ...
         {/* <!-- <p>Don't have an account!</p>  --> */}
           ...
           <form action="/reset/" class="form-reset">
             ...
             <div className="social-login">
                     <button class="btn facebook-btn social-btn" type="button"><span><i className="fab fa-facebook-f"></i> Sign up with Facebook</span> </button>
                 </div>
                 <div className="social-login">
             ...
             <button class="btn btn-primary btn-block" type="submit"><i className="fas fa-user-plus"></i> Sign Up</button>
                 <a href="#" id="cancel_signup"><i className="fas fa-angle-left"></i> Back</a>//         </form>
             <br/>
